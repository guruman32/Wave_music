...
class SettingsFragment : Fragment() {
    ...
    override fun onActivityCreated(@Nullable savedInstanceState: Bundle?) {
        ...
        val prefs = _activity?.getSharedPreferences(Statified.MY_PREFS_NAME, MODE_PRIVATE)
        ...
        shakeSwitch?.setOnCheckedChangeListener({ compoundButton, b ->
            if (b) {
                val editor = activity?.getSharedPreferences(Statified.MY_PREFS_NAME, MODE_PRIVATE)?.edit()
